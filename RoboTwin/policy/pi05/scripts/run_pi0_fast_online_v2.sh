...
REPO_ROOT=${4:-}
VALUE_WS_URL=${5:-}
EXPLORE_MODE=${6:-always}
EXPLORE_KEYFRAME_THRESHOLD=${7:-0.5}
EXPLORED_CHUNK_WEIGHT=${8:-1.0}
NON_EXPLORED_CHUNK_WEIGHT=${9:-1.0}
EXPLORE_PERTURB_BACKEND=${10:-dct_gaussian}
EXPLORE_ACTION_RADIUS_MIN=${11:-0.0}
EXPLORE_ACTION_RADIUS_MAX=${12:-0.15}
EXPLORE_ACTION_ABS_CLIP=${13:-1.0}
EXPLORE_NETWORK_MIX_ALPHA=${14:-0.5}
EXPLORE_NETWORK_CKPT=${15:-}
EXPLORE_NETWORK_OBS_DIM=${16:-32}
EXPLORE_NETWORK_LATENT_DIM=${17:-16}
EXPLORE_KEYFRAME_GATE=${18:-model_head}
EXPLORE_KEYFRAME_NET_CKPT=${19:-}
EXPLORE_ACTION_NOISE_DIMS=${20:-}
