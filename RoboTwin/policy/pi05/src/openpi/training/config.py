...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        model=pi0_fast.Pi0FASTConfig(action_dim=14, action_horizon=32, paligemma_variant="gemma_2b_lora"),
        data=LeRobotAlohaDataConfig(
            repo_id="your_repo_id",  # your datasets repo_id
            adapt_to_pi=False,
            repack_transforms=_transforms.Group(inputs=[
    ...
    TrainConfig(
        ...
        data=LeRobotAlohaDataConfig(
            repo_id="lerobot-hammer-100",  # your datasets repo_id
            adapt_to_pi=False,
            repack_transforms=_transforms.Group(inputs=[
                _transforms.RepackTransform({
                    "images": {
        ...
        # pi0_fast_base by full
    TrainConfig(
        name="pi0_fast_aloha_robotwin_ppo",
        model=pi0_fast.Pi0FASTConfig(action_dim=14, action_horizon=32),
        data=LeRobotAlohaDataConfig(
            repo_id="lerobot-hammer-100",  # your datasets repo_id
            adapt_to_pi=False,
